...
{
  public class UserControlDespacho : UserControlCareCargoBase
  {
    ...
    private DespachoWraper objDespachoWraper;
    ...
    public UserControlDespacho(List<SearchResult> objSearch = null)
    {
      this.InitializeComponent();
      this.ObjSearch = objSearch;
      this.dbEnt = new cargocareEntities();
      this.objDespachoWraper = new DespachoWraper();
    ...
    private void InitializeComponent()
    {
            ...
            this.kryptonHeader1.Values.Description = "Conduce para el despacho de Camiones";
            this.kryptonHeader1.Values.Heading = "Despacho de Camiones";
            // 
            // kryptonPanel2
            // 
            ...
            this.kryptonDockableNavigatorTab.SelectedIndex = 0;
            ...
            this.kryptonDataGridViewDomainUpDownColumn1.HeaderText = "Cantidad Conduce";
            ...
            this.kryptonDataGridViewComboBoxColumn2.HeaderText = "Cantidad Medida";
    ...
    private void prepareControls()
    {
      ...
      if (this.ObjSearch != null && this.ObjSearch.Count > 0)
        this.currentDespacho = this.objDespachoWraper.GetDespachoById(new int?(this.getAsInt(this.ObjSearch, true)));
      this.kryptonComboBoxMedia.DataSource = (object) this.objDespachoWraper.GetUnits();
    ...
    private void userControlSingleSearchCliente_OnValueChanged(List<SearchResult> resultList, string displayValue)
    {
      ...
      this.listaSellos = this.objDespachoWraper.GetSellosNamedValue(this.currentDespacho, this.currentCliente);
      ...
      this.kcomboSelloBocaCarga.ValueMember = this.kcomboselloBocaDescarga.ValueMember = this.kcomboSelloChapa.ValueMember = "IdSello";
      this.kcomboSelloBocaCarga.DisplayMember = this.kcomboselloBocaDescarga.DisplayMember = this.kcomboSelloChapa.DisplayMember = "CodSello";
    ...
    private void prepareGrids()
    {
      ...
      this.listaProductos = this.objDespachoWraper.GetProductNamedValue();
    ...
    {
      this.currentDetaSelloCarga = this.objDespachoWraper.GetDetalleObject(this.currentDespacho, this.currentCamion, this.currentCliente);
      this.currentMediaCarga = this.objDespachoWraper.GetProductDetalleObject(this.currentDespacho, this.currentCamion);
      this.currentVeriCarga = this.objDespachoWraper.GetVerificacionObject(this.currentDespacho);
    ...
    private void saveDetails()
    {
      ...
      this.objDespachoWraper.SaveDetalleSellos(this.currentDetaSelloCarga, this.currentDespacho);
      this.objDespachoWraper.SaveDetalleMedida(this.currentMediaCarga, this.currentDespacho);
      this.objDespachoWraper.SaveDetalleVerificacion(this.currentVeriCarga, this.currentDespacho);
    }
    ...
    private void saveHeader()
    {
      ...
      this.currentDespacho = this.objDespachoWraper.Save(idDespacho, Global.CurrentUserID, asInt4, asInt2, asInt3, asInt1, idUnidad, horaInicio, horaFin, this.kryptonTextBoxComentario.Text, this.kryptonTextBoxReferencia.Text) ?? this.currentDespacho;
    }
    ...
    private bool valideteGridSellos()
    {
      ...
      IEnumerable<DataGridViewCell> source = gridSellos.Where<DataGridViewCell>((Func<DataGridViewCell, bool>) (c =>
      {
        if (CellsValues.Where<object>((Func<object, bool>) (s =>
        {
          ...
          return !c.Value.Equals((object) 71);
        return false;
      }));
    ...
    private void toolStripButtonComplete_Click(object sender, EventArgs e)
    {
      try
      {
        if (!this.ValidateComplete())
          return;
        this.objDespachoWraper.MakeComplete(this.currentDespacho.IdInspeccion);
