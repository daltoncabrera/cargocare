...
{
  public class UserControlStatus : UserControlCareCargoBase
  {
    ...
    public UserControlStatus(List<SearchResult> objSearch = null)
    {
    ...
    {
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (UserControlDespacho));
      ...
      this.Name = "UserControlRegisterComponent";
