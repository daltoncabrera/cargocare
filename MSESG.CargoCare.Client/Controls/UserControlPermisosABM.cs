...
{
  public class UserControlPermisosABM : UserControlCareCargoBase
  {
    ...
    public UserControlPermisosABM(List<SearchResult> objSearch = null)
    {
    ...
    private void InitializeComponent()
    {
      ...
      this.kryptonHeader1.Size = new Size(437, 4);
